...
import AnnualFestSlider from "./AnnualFestSlider"; // Path to your AnnualFestSlider component
...
const AnnualFestPage = () => {
  ...
  const events = [
    ...
    },
    {
      ...
      description3:"Round 1 features 50 diverse questions to be solved in 30 minutes, with the top 3 competitors progressing to the Final Round. Round 2, face two jumbled or incomplete code questions in 60 minutes – C++ language allowed.",
      description4:
